...
This is the historic 2009 CVS source. No updates to this 
source has been done since that 2009 date.

The current HTML Tidy source is https://github.com/htacg/tidy-html5

The current HTML Tidy web page is http://www.html-tidy.org/

The current source ONLY uses CMake to do the configuration,
and generation of native build systems supported by cmake.
